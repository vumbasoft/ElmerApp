...
public class ErmanAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ErmanAppGlobalFeatureConfigurator.Configure();
        ErmanAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ErmanAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ErmanAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ErmanApp");

            options.DefaultResourceType = typeof(ErmanAppResource);
        ...
        {
            options.MapCodeNamespace("ErmanApp", typeof(ErmanAppResource));
        });
    }
}
