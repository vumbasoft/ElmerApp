...
{
    /// <inheritdoc />
    public partial class Added_StateProvince : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppStateProvinces_AppCountries_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppStateProvinces_CountryId",
                table: "AppStateProvinces",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStateProvinces_Name",
                table: "AppStateProvinces",
                column: "Name");
        }
